...
function getInitials($name) {
    ...
    return $initials ?: 'U'; // Default 'U' jika nama kosong atau hanya spasi
}
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center">
                    <?php if (isset($_SESSION['user_id'])) : ?>
                        <a href="keranjang.php" class="text-dark me-3"><i class="bi bi-cart fs-5"></i></a> <a href="#" class="text-dark me-4"><i class="bi bi-bell fs-5"></i></a>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end text-small shadow">
                                ...
                                <li><a class="dropdown-item" href="keranjang.php">Keranjang Saya</a></li> <li><a class="dropdown-item" href="#">Notifikasi</a></li>
