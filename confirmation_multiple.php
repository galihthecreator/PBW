        ...
        <div class="col-md-8">
            <div class="card text-center shadow-sm">
                <div class="card-header bg-success text-white">
                    <h4 class="mb-0">Pesanan Diterima!</h4>
                </div>
                <div class="card-body p-4">
                    <p class="lead">Terima kasih. Mohon selesaikan pembayaran total Anda.</p>
                    <hr>
                    ...
                    <a href="dashboard.php" class="btn btn-primary mt-4">Pergi ke Kelas Saya</a>
                </div>
            </div>
        </div>
    </div>
